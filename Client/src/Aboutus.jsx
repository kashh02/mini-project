          ...
          <div className="flex flex-col items-center space-y-6 md:space-y-0 md:space-x-8">
            <div className="w-full md:w-1/2">
              <p className="text-green-700 leading-relaxed">
                We are passionate food lovers dedicated to bringing the most
                delicious and authentic culinary experiences to your table. Our
                journey began with a simple dream: to create a place where food
                tells a story, and every bite is a memorable adventure.
              </p>
            </div>
          ...
          <div className="grid md:grid-cols-3 gap-6">
            ...
            <div className="bg-green-50 p-6 rounded-lg shadow-md hover:shadow-xl transition-shadow">
              ...
              <p className="text-green-700">
                Discover the best local restaurants in your area, curated with
                love and passion for authentic flavors and unique dining
                experiences.
              </p>
            </div>
            ...
            <div className="bg-green-50 p-6 rounded-lg shadow-md hover:shadow-xl transition-shadow">
              ...
              <p className="text-green-700">
                Get inspired with innovative recipes, cooking tips, and culinary
                trends that will transform your home cooking and dining
                adventures.
              </p>
            </div>
            ...
            <div className="bg-green-50 p-6 rounded-lg shadow-md hover:shadow-xl transition-shadow">
              ...
              <p className="text-green-700">
                Explore a collection of world-renowned dishes, regional
                specialties, and cultural culinary treasures that tell delicious
                stories.
              </p>
            </div>
          </div>
